 ...
 */
public class StartExperimentSFCEdge2 {
    ...
    public static void setExpName(String policy, String sfOn, String cloud_only) {
        if (Configuration.SFC_LATENCY_AWARE_ENABLE) {
            if ("1".equals(cloud_only)) {
                Configuration.experimentName = String.format("SFC_2_On_%s_%d_%s_", sfOn, (int) Configuration.migrationTimeInterval,
                        policy
                );
            } else {
                Configuration.experimentName = String.format("SFC_1_On_%s_%d_%s_", sfOn, (int) Configuration.migrationTimeInterval,
                        policy
                );
            }
        } else {
            ...
            if ("1".equals(cloud_only)) {
                Configuration.experimentName = String.format("SFC_2_Off_%s_%d_%s_", sfOn, (int) Configuration.migrationTimeInterval,
                        policy
                );
            } else {
                Configuration.experimentName = String.format("SFC_1_Off_%s_%d_%s_", sfOn, (int) Configuration.migrationTimeInterval,
                        policy
                );
            }
        }
...
//		}
        ...
        setExpName(policy, sfcOn, cloud_only);
...
//					hostSelectionPolicy, vmMigrationPolicy);
            ...
            if (!StartExperimentSFCEdge2.logEnabled)
                Log.disable();
